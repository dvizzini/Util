...
public class InstantiationUtil {
	 ...
	 * @return an array list with the elements in the order entered
	 */
	public static <E> ArrayDeque<E> newArrayDeque(@SuppressWarnings("unchecked") E... elements) {
	 ...
	 * WARNING: There is no type-checking on the parameter list. Use this method carefully and only to instantiate final variables.
